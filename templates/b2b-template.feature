You can use this template as a starting point for creating your PRD for B2B products using Carrot syntax. Adjust and expand the sections as needed to fit your specific project requirements and objectives
